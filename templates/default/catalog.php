		...
		<div class="products__container _container">
				...
				<section class="plant__body plant">
					<div class="plant__container">
						<div class="plant__content">
							<h3 class="plant__title"><?= $data['name'] . ' в магазине «Сундучок» Донецк, Макеевка ДНР' ?></h3>
			...
			<div class="s-content" style="margin-top: 35px">
				<div class="content-block">
					<p class="text-attention"><?= ($data['name'] !== 'Каталог') ? $data['name'] : $this->set['keywords'] ?> купить в Донецке, Макеевке ДНР по адресу: <?= $this->set['address'] ?>. Сделать заказ можно по тел. <?= $this->set['phone'] ?>. Цены доступные. Есть возможность доставки по Донецку, Макеевке. Свяжитесь с нами! Мы поможем собрать набор под любой повод и бюджет, стильно оформим и подготовим к вручению. Звоните или напишите нам — подскажем лучшие сочетания!</p>
